      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="/LearningCommunity/manage/course/courses?pageNum=1&pageSize=5"  <c:if test="${module eq 'course'}">class="active"</c:if> ><i class="fa fa-database fa-fw"></i>课程管理</a></li>
