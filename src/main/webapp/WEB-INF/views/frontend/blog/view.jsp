    		...
    		<div class="blog-main">
    			...
    			<div class="blog-comment">
    				<h2 class="h4 blog-comment-title">${comments.list.size()}条评论</h2>
    				  <c:forEach var="comment" items="${comments.list}" varStatus="status">
    											<div class="blog-comment-item clearfix">
						<div class="blog-comment-header">
							<a href="" class="blog-comment-author"><img src="default.png" class="avatar-32" alt="">${comment.user.userName}</a>
    			...
    			<div class="blog-write">
						...
						<div class="blog-write-content clearfix">
							<form action="/LearningCommunity/blog/comment/${blog.blogId}" method="post">
	    		...
	    		<div class="sidebar-item">
					...
					<ul class="blog-hot-author">
						<li class="author-item clearfix">
							...
							<p class="moto">${blog.user.motto }</p>
						</li> 
					</ul>
	    		</div>  
	    		<div class="sidebar-item">
					...
					<ul class="blog-author-others">
						<li class="others-item clearfix"><a href="">其他文章1111</a></li> 
						<li class="others-item clearfix"><a href="">其他文章1111</a></li> 
						<li class="others-item clearfix"><a href="">其他文章1111</a></li> 
					</ul>
	    		</div> 	    		  		
