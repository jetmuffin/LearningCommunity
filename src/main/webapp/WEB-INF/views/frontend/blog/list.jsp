	 ...
	 <div id="blog">
    	<div class="container">
			<div class="blog-main">
				<p class="main-title">
                    今天，有什么心得感悟分享给大家呢？
                    <a id="goWrite" href="/LearningCommunity/blog/add" class="btn btn-primary btn-lg">撰写文章</a>
                </p>
                <div class="main-tab">
                	<a href="" class="blog-tab active">最新</a>
                	<a href="" class="blog-tab">最热</a>
                </div>
                <div class="main-list">
                	  <c:forEach var="blog" items="${page.list}">
	                 	<div class="blog-item clearfix">
					      	...
					      	<div class="blog-summary">
					      		<p>kingshard简介 kingshard是一个由Go开发高性能MySQL Proxy项目，kingshard在满足基本的读写分离的功能上，致力于简化MySQL分库分表操作；能够让DBA通过kingshard轻松平滑地实现MySQL数据库扩容。 主要功能： {代...</p>
					      	</div>
					      	<div class="blog-footer clearfix">
					      		<div class="blog-author l"><a href=""><img src="default.png" class="avatar-20" alt="">${blog.user.userName}</a></div>
								<div class="blog-time l">${blog.time}</div>
								<div class="blog-tag-list l">
									<a href="" target="_blank" class="list-tag">${blog.tag}</a>
								</div>
	    	...
	    	<div class="blog-sidebar">
	    		<div class="sidebar-item">
	    			<h3 class="item-title">我的讨论<a>»</a></h3>
	    		...
	    		<div class="sidebar-item">
					<h3 class="item-title">热门作者<a>»</a></h3>
	    		...
	    		<div class="sidebar-item">
					<h3 class="item-title">热门标签<a>»</a></h3>
